...
export interface DashboardData {
    ...
    avg_course_completion: number; // 0-100
    top_difficult_granules: GranuleMetric[];
    most_viewed_granules: GranuleMetric[];
    last_updated: string;
}

// ── Notifications et Alertes Enseignant ──
export interface TeacherAlert {
    id: string;
    type: "difficulty_spike" | "drop_out_risk" | "ai_confusion";
    course_id: string;
    course_title: string;
    granule_id?: string;
    granule_title?: string;
...
// ============================================================================
// --- AJOUTS MODULE 3 (INTÉGRATION BACKEND DJANGO) ---
// ============================================================================
...
export interface DifficultyZone {
    concept: string; // Le titre du granule
