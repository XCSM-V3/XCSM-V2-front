...
// ─────────────────────────────────────────────────────────────
// XCSM V3 — main-sidebar.tsx (version finale avec Commentaires)
// Remplace components/ui/main-sidebar.tsx
// ─────────────────────────────────────────────────────────────
...
export function MainSidebar() {
  ...
  const getUserInitials = () => {
    ...
    if (user.prenom) return user.prenom.substring(0, 2).toUpperCase()
    if (user.nom) return user.nom.substring(0, 2).toUpperCase()
      ...
      <div className="flex flex-col h-full">
        ...
        <div className="p-4 border-t border-border">
          {isAuthenticated && user ? (
            ...
            <div className="flex items-center gap-3">
              <div className="h-8 w-8 rounded-full bg-gray-300 flex items-center justify-center text-white">?</div>
              <div>
...
//       roles: ["enseignant", "admin"],
//     },
//     // ── AJOUT : Lien Analytics (enseignant uniquement) ──────────
//     {
//       title: "Analytics",
//       href: "/dashboard/analytics",
//       icon: BarChart3,
...
//         {/* Bouton créer document (enseignant) */}
//         {user?.role === "enseignant" && (
//           <div className="p-4">
//             <Button className="w-full bg-green-600 hover:bg-green-700" size="sm">
//               <PlusCircle className="mr-2 h-4 w-4" />
...
// import { BarChart3 } from "lucide-react"  // Ajouter à vos imports Lucide existants
